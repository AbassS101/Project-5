...
public class MorseCodeConverterTestPublic {
	...
	@Test
	public void testSTUDENTConvertMorseStringToEnglishString() {	
		
		String converter1 = MorseCodeConverter.convertToEnglish("-- -.-- / -. .- -- . / .. ... / .- -... .- ... ...");
		assertEquals("my name is abass", converter1);

	}
	
	@Test
	public void testSTUDENTConvertMorseFileToEnglishString() {	
		
		/*Make sure Daisy.txt is in the src directory for this 
		  test to pass
		*/
